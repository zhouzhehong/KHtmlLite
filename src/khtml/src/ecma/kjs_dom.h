...
public:
    ...
    JSValue *toPrimitive(ExecState *exec, JSType preferred = UndefinedType) const override;
...
public:
    ...
    static const ClassInfo info;
    enum { TagName, Style, ClassList, Dataset, FirstElementChild, LastElementChild,
