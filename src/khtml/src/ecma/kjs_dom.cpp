...
@begin DOMElementTable 9
  tagName       DOMElement::TagName                 DontDelete|ReadOnly
  style         DOMElement::Style                   DontDelete|ReadOnly
  classList     DOMElement::ClassList               DontDelete|ReadOnly
  dataset       DOMElement::Dataset                 DontDelete|ReadOnly
...
JSValue *DOMElement::getValueProperty(ExecState *exec, int token) const
{
    ...
    case ClassList:
        return getDOMTokenList(exec, &element);
    case Dataset:
        return getDOMStringMap(exec, &element);
