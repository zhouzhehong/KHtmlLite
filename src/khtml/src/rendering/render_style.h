...
public:
    StyleFlexibleBoxData()
        : flexDirection(0), justifyContent(0), alignItems(0),
          flexGrow(0), flexWrap(false), gap(0)
    {
    }
    StyleFlexibleBoxData(const StyleFlexibleBoxData &o)
        : Shared<StyleFlexibleBoxData>(),
          flexDirection(o.flexDirection), justifyContent(o.justifyContent),
          alignItems(o.alignItems), flexGrow(o.flexGrow),
          flexWrap(o.flexWrap), gap(o.gap)
    {
    }

    bool operator==(const StyleFlexibleBoxData &o) const
    {
        return flexDirection == o.flexDirection && justifyContent == o.justifyContent
            && alignItems == o.alignItems && flexGrow == o.flexGrow
            && flexWrap == o.flexWrap && gap == o.gap;
    }
    bool operator!=(const StyleFlexibleBoxData &o) const
    ...
    // 0=row 1=row-reverse 2=column 3=column-reverse (matches FlexDir)
    int flexDirection;
    // 0=flex-start 1=center 2=flex-end 3=space-between 4=space-around
    int justifyContent;
    // 0=stretch 1=flex-start 2=center 3=flex-end
    int alignItems;
    float flexGrow;
    bool flexWrap;
    int gap;
...
enum EDisplay {
    ...
    TABLE_CAPTION, FLEX, INLINE_FLEX, NONE
};
...
// attribute getter methods
    ...
    // --- minimal flexbox (RenderFlexBox) ---
    int flexDirection() const
    {
        return css3NonInheritedData->flexibleBox->flexDirection;
    }
    void setFlexDirection(int v)
    {
        if (css3NonInheritedData->flexibleBox->flexDirection != v) {
            css3NonInheritedData.access()->flexibleBox.access()->flexDirection = v;
        }
    }
    int justifyContent() const
    {
        return css3NonInheritedData->flexibleBox->justifyContent;
    }
    void setJustifyContent(int v)
    {
        if (css3NonInheritedData->flexibleBox->justifyContent != v) {
            css3NonInheritedData.access()->flexibleBox.access()->justifyContent = v;
        }
    }
    int alignItems() const
    {
        return css3NonInheritedData->flexibleBox->alignItems;
    }
    void setAlignItems(int v)
    {
        if (css3NonInheritedData->flexibleBox->alignItems != v) {
            css3NonInheritedData.access()->flexibleBox.access()->alignItems = v;
        }
    }
    float flexGrow() const
    {
        return css3NonInheritedData->flexibleBox->flexGrow;
    }
    void setFlexGrow(float v)
    {
        if (css3NonInheritedData->flexibleBox->flexGrow != v) {
            css3NonInheritedData.access()->flexibleBox.access()->flexGrow = v;
        }
    }
    bool flexWrap() const
    {
        return css3NonInheritedData->flexibleBox->flexWrap;
    }
    void setFlexWrap(bool v)
    {
        if (css3NonInheritedData->flexibleBox->flexWrap != v) {
            css3NonInheritedData.access()->flexibleBox.access()->flexWrap = v;
        }
    }
    int gap() const
    {
        return css3NonInheritedData->flexibleBox->gap;
    }
    void setGap(int v)
    {
        if (css3NonInheritedData->flexibleBox->gap != v) {
            css3NonInheritedData.access()->flexibleBox.access()->gap = v;
        }
    }
